...
Kindly start by cloning the repository : https://github.com/gharianiemna/Module-6-REST-APIs.git
Then Import a Collection into Postman follwing these steps:
...
4-Choose the file: Leçon 6.1 - Client REST.postman_collection (1)
5-Hit the open button, and your file/collection will be imported automatically.
You can also drag the file and drop the file in Postman’s import panel, and it will be imported automatically.
